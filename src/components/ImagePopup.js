...
function ImagePopup(props) {
    return(
        <div className={`popup popup_photo_cards ${props.card ? 'popup_opened' : ''}`} onClick={props.onClickOverlay}>
            <div className="popup__container-cards">
                ...
                <img type="url" src={props.card ? props.card.link : ''} alt="Изображение картинки"
